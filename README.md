...
The project is developed in Delphi and uses a SQLite database. It can be compiled for Windows, Mac and Linux, but could also run on tablets and smartphones (iOS & Android) provided that a button bar is added to replace the main menu.

This code repository contains a project developed in Object Pascal language under Delphi. You don't know what Delphi is and where to download it ? You'll learn more [on this web site](https://delphi-resources.developpeur-pascal.fr/).

## Using this software

Visit [the YT Video Series website](https://ytvideoseries.olfsoftware.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/YTVideoSeries).
...
* [DeveloppeurPascal/DelphiBooks-Common](https://github.com/DeveloppeurPascal/DelphiBooks-Common) must be installed in the ./lib-externes/DelphiBooks-Common subfolder.
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/YTVideoSeries) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://ytvideoseries.olfsoftware.fr) or [the project devlog](https://developpeur-pascal.fr/yt-video-series.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/YTVideoSeries/issues) so that I can test and try to correct or provide a workaround.
...
If this license doesn't suit your needs (especially for a commercial project) I also offer [classic licenses for developers and companies](https://ytvideoseries.olfsoftware.fr).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/YTVideoSeries) and [open a new issue](https://github.com/DeveloppeurPascal/YTVideoSeries/issues).
